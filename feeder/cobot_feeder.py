...
class Feeder_dual(torch.utils.data.Dataset):
    ...
    def __init__(self, data_path, label_path, shear_amplitude=0.5, temperal_padding_ratio=6, mmap=True, aug_method=''):
        self.data_path = data_path
        self.label_path = label_path
        self.aug_method = aug_method
...
class Feeder_semi(torch.utils.data.Dataset):
    """ Feeder for single inputs """
    def __init__(self, data_path, label_path, label_percent=0.1, shear_amplitude=0.5, temperal_padding_ratio=6, mmap=True, zero_z=False):
        self.data_path = data_path
        self.label_path = label_path
