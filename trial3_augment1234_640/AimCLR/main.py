...
if __name__ == '__main__':
    ...
    processors['pretrain_aimclr_v2'] = import_class('processor.pretrain_aimclr_v2.AimCLR_Processor')
    processors['pretrain_aimclr_v2_3views'] = import_class('processor.pretrain_aimclr_v2_3views.AimCLR_3views_Processor')
